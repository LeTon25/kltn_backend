...
namespace KLTN.Infrastructure.Migrations
{
    ...
    [Migration("20241129150327_changeOnDeleteBehaviorOnScoreAndSubmission")]
    partial class changeOnDeleteBehaviorOnScoreAndSubmission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Assignment", b =>
                {
                    ...
                    b.Property<bool>("IsGroupAssigned")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsIndividualSubmissionRequired")
                        .HasColumnType("tinyint(1)");

                    b.Property<string>("JobId")
                        .HasColumnType("longtext");

                    b.Property<string>("ScoreStructureId")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Brief", b =>
                {
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Group", b =>
                {
                    ...
                    b.Property<DateTime?>("InviteCodeExpired")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Request", b =>
                {
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Score", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Setting", b =>
                {
                    b.Property<string>("SettingId")
                        .HasColumnType("varchar(255)");

                    b.Property<bool>("AllowStudentCreateProject")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<DateTime?>("DueDateToJoinGroup")
                        .HasColumnType("datetime(6)");

                    b.Property<bool>("HasFinalScore")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Submission", b =>
                {
                    b.Property<string>("SubmissionId")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Assignment", b =>
                {
                    ...
                    b.HasOne("KLTN.Domain.Entities.ScoreStructure", "ScoreStructure")
                        .WithOne("Assignment")
                        .HasForeignKey("KLTN.Domain.Entities.Assignment", "ScoreStructureId")
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Brief", b =>
                {
                    ...
                    b.HasOne("KLTN.Domain.Entities.Report", "Report")
                        .WithOne("Brief")
                        .HasForeignKey("KLTN.Domain.Entities.Brief", "ReportId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Group", b =>
                {
                    b.HasOne("KLTN.Domain.Entities.Assignment", "Assignment")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Score", b =>
                {
                    b.HasOne("KLTN.Domain.Entities.ScoreStructure", "ScoreStructure")
                        .WithMany("Scores")
                        .HasForeignKey("ScoreStructureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KLTN.Domain.Entities.Submission", "Submission")
                        .WithMany("Scores")
            ...
            modelBuilder.Entity("KLTN.Domain.Entities.Setting", b =>
                {
                    b.HasOne("KLTN.Domain.Entities.Course", "Course")
                        .WithOne("Setting")
                        .HasForeignKey("KLTN.Domain.Entities.Setting", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
